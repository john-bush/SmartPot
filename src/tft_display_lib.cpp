...
void TFTDisplay::ClearDisplay () {
  ...
  Command(0x3A); Data(0x03);               // 12-bit color
  ...
  Command(0x3A); Data(0x05);               // Back to 16-bit color
  PORT_TOGGLE(1<<cs);
}
...
void TFTDisplay::DrawImage(const uint16_t *image, int w, int h, int centerX, int centerY) {
